...
// the face
 ...
 rotate([0, 0,-120]) Eyes() ;
                    ...
                    translate([5, 0,4]) import("Mouth.stl");
 rotate([0, 0,-120])translate([5, 0,4]) import("Sad_Mouth.stl");
 
 rotate([0, 0, 120])translate([5, 0,4]) import("Mouth.stl");
 rotate([0, 0, 120])translate([5, 0,4]) import("Sad_Mouth.stl");
